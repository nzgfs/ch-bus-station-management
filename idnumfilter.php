...
<div id='nav'>
    ...
    <div id='salepage'>
        ...
        <div id='form'>
            ...
            $sql = "SELECT Name, passengers.Idnum, Phone, Busnum
                    FROM passengers, busandpass
                    WHERE passengers.Idnum=busandpass.Idnum and passengers.Idnum='$p' and Date='$d'";
            ...
            echo '<table class="info">
                <tr>
                    ...
                    <th style="border-radius: 0 19px 0 0;">车次</th>
                </tr>';
